...
from _math import Math, SolveEquations
...
class Conversations():
    def __init__(self):
        ...
        self.special_dictionary = {'百度百科搜索':'f1', '中英单词互译':'f2', '百度搜索引擎':'f3',
                                   '提取百度搜索结果链接':'f3f0', '等差数列计算':'f4','几何形体计算':'f5',
                                   '完全平方数查找':'f6', '文章生成器':'f7', '解一元方程':'f8', '密码安全生成':'f9'}
...
class SpecialFunctions():
    ...
    def f8(self):
        print("[解一元方程]可解一元任意次方程\n")
        f = SolveEquations()
        print("")

    def f9(self):
        print("[密码安全生成]帮你生成不同安全级别的密码\n")
        g = GetPassword()
        print("")
